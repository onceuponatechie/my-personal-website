          ...
          <div className="mt-14 grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-sage px-6 py-3 text-[14px] font-medium text-white transition hover:bg-butter hover:text-ink"
              >
                Visit live site
