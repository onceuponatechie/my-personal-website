      ...
      <header className="relative overflow-hidden px-4 pt-14 pb-12 sm:px-6 sm:pt-16">
        <div className="relative mx-auto max-w-3xl">
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <div className="flex flex-wrap items-center gap-3 text-[13px] uppercase tracking-[0.18em] text-ink/45">
          ...
          {entry.gated && (
            <div className="mt-12 overflow-hidden rounded-[28px] border border-dashed border-ink/15 bg-card p-8 text-center">
              ...
              >
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center gap-1.5 rounded-full bg-ink px-6 py-3 text-[14px] font-medium text-white transition hover:bg-sage"
                >
                  Send it
      ...
      <section className="px-4 pb-24 sm:px-6">
        <div className="mx-auto max-w-4xl space-y-10">
                ...
                {related.map((r) => (
                  <Link key={r.slug} href={`/resources/vault/${r.slug}`} className="group block h-full">
                    <article className="flex h-full flex-col rounded-[24px] bg-card p-6 ring-1 ring-black/5 transition duration-300 group-hover:-translate-y-1 group-hover:ring-black/10">
                      ...
                      <h3 className="mt-3 text-[19px] font-semibold leading-[1.3] tracking-[-0.04em] text-ink">
                        {r.title}
                      </h3>
          ...
          <div className="flex flex-col items-start justify-between gap-5 rounded-[28px] bg-ink p-8 text-white sm:flex-row sm:items-center">
            <div>
              <p className="inline-flex items-center gap-2 text-[12px] uppercase tracking-[0.2em] text-white/55">
            ...
            <Link
              ...
              className="group inline-flex shrink-0 items-center gap-2 rounded-full bg-sage px-6 py-3 text-[14px] font-medium text-white transition hover:bg-ink"
            >
              Browse resources
