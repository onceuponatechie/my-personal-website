      ...
      <div className="grid gap-9 md:grid-cols-[1.15fr_1fr] md:items-center">
        <div>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            <span className="group inline-flex cursor-pointer items-center gap-2 rounded-full btn-ink px-5 py-2.5 text-[13px] font-medium text-white transition">
              Download free
            ...
            {sent ? (
              <div className="flex flex-col items-center py-6 text-center">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="mt-6 rounded-full btn-ink px-6 py-2.5 text-[13px] font-medium text-white transition"
                >
                  Back to the shelf
                </button>
              </div>
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full btn-sage px-6 py-3 text-[14px] font-medium text-white transition"
                >
                  Send request
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="relative inline-flex shrink-0 items-center gap-2 self-start rounded-full btn-sage px-5 py-2.5 text-[13px] font-medium text-white transition sm:self-auto"
        >
