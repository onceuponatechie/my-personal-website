        ...
        <div className="mx-auto max-w-2xl">
          ...
          <Reveal delay={0.08} className="mt-4">
            ...
            >
              ...
              <span className="relative inline-flex shrink-0 items-center gap-2 rounded-full btn-sage px-5 py-2.5 text-[13px] font-medium text-white transition group-hover:gap-3">
