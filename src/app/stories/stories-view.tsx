    ...
    >
      ...
      >
        ...
        <div className="flex flex-1 flex-col px-3 pb-2 pt-4">
          <div className="flex items-center gap-2.5 text-[14px] text-ink/50">
            <span>{story.date}</span>
            <span className="size-1 rounded-full bg-ink/30" />
            <span>{story.read}</span>
          </div>
          <h3 className="mt-2.5 font-display text-[18px] leading-[1.25] text-ink">
            {story.title}
          </h3>
          ...
          <div className="grid items-center gap-12 md:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              >
                ...
                <span className="inline-flex items-center gap-2 rounded-full border border-ink/15 px-5 py-3 text-[14px] text-ink/70">
        ...
        >
          ...
          >
            <div className="relative overflow-hidden rounded-[28px]">
              ...
              />
              <span className="absolute left-4 top-4 inline-flex items-center gap-2 rounded-full bg-sage-soft px-3 py-1 text-[12px] uppercase tracking-[0.18em] text-ink/70">
                Latest entry
              </span>
            </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative inline-flex items-center rounded-full px-4 py-2.5 text-[14px] font-medium transition ${
