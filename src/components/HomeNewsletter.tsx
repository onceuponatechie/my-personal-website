      ...
      >
        ...
        <div className="relative grid items-center gap-10 md:grid-cols-[1.15fr_1fr] md:gap-14">
          ...
          >
            ...
            <button
              type="submit"
              className="group mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-sage px-6 py-3.5 text-[14px] font-medium text-white transition hover:brightness-105"
            >
              Get the good stuff
