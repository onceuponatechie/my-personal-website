    ...
    <motion.article variants={dirCard(dir)} whileHover={{ y: -4 }} transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }} className={`${R} ${className} group/card relative overflow-hidden bg-card p-6`}>
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="mt-auto flex items-end justify-between pt-10">
          ...
          <span className="pointer-events-none relative z-20 inline-flex items-center gap-1.5 rounded-full btn-ink py-2 pl-4 pr-1.5 text-[13px] font-medium text-white transition group-hover/card:gap-2.5">
            Explore
    ...
    <motion.article variants={dirCard(dir)} whileHover={{ y: -4 }} transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }} className={`${R} ${className} group/card relative overflow-hidden bg-sage-soft`}>
      ...
      <div className="flex h-full flex-col md:flex-row md:items-stretch">
        ...
        >
          ...
          <motion.span
            variants={textChild}
            className="pointer-events-none relative z-20 mt-5 inline-flex w-fit items-center gap-1.5 rounded-full btn-ink py-2 pl-4 pr-1.5 text-[13px] font-medium text-white transition group-hover/card:gap-2.5"
          >
            Explore
            <span className="grid size-6 place-items-center rounded-full bg-white text-ink transition-transform group-hover/card:translate-x-0.5 group-hover/card:-translate-y-0.5">
              <ArrowUpRight className="size-3.5" strokeWidth={2.4} />
